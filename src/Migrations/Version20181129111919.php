 ...
 */
final class Version20181129111919 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banco RENAME TO bank');
        ...
        $this->addSql('CREATE TABLE cheque_emitido (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, numero VARCHAR(255) NOT NULL COLLATE BINARY, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL, CONSTRAINT FK_F6395884CC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__bank_xlsstructure AS SELECT id, banco_id, stop_word, first_header, first_row, concept_col, amount_col, date_col, date_format FROM bank_xlsstructure');
        $this->addSql('DROP TABLE bank_xlsstructure');
        $this->addSql('CREATE TABLE bank_xlsstructure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, stop_word VARCHAR(255) DEFAULT NULL COLLATE BINARY, first_header VARCHAR(255) DEFAULT NULL COLLATE BINARY, first_row SMALLINT NOT NULL, concept_col SMALLINT NOT NULL, amount_col SMALLINT NOT NULL, date_col SMALLINT NOT NULL, date_format VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_57B3CF5ECC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO bank_xlsstructure (id, banco_id, stop_word, first_header, first_row, concept_col, amount_col, date_col, date_format) SELECT id, banco_id, stop_word, first_header, first_row, concept_col, amount_col, date_col, date_format FROM __temp__bank_xlsstructure');
        ...
        $this->addSql('CREATE TABLE movimiento (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, clon_de_id INTEGER DEFAULT NULL, concepto VARCHAR(255) NOT NULL COLLATE BINARY, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL, concretado BOOLEAN NOT NULL, CONSTRAINT FK_C8FF107ACC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C8FF107AB5DD50A6 FOREIGN KEY (clon_de_id) REFERENCES gasto_fijo (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gasto_fijo AS SELECT id, banco_id, concepto, dia, importe, fecha_fin FROM gasto_fijo');
        $this->addSql('DROP TABLE gasto_fijo');
        $this->addSql('CREATE TABLE gasto_fijo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, concepto VARCHAR(255) NOT NULL COLLATE BINARY, dia INTEGER NOT NULL, importe NUMERIC(10, 2) NOT NULL, fecha_fin DATETIME DEFAULT NULL, CONSTRAINT FK_F9E4C2D2CC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO gasto_fijo (id, banco_id, concepto, dia, importe, fecha_fin) SELECT id, banco_id, concepto, dia, importe, fecha_fin FROM __temp__gasto_fijo');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE banck RENAME TO banco');
        $this->addSql('DROP INDEX UNIQ_57B3CF5ECC04A73E');
        $this->addSql('CREATE TEMPORARY TABLE __temp__bank_xlsstructure AS SELECT id, banco_id, first_row, stop_word, concept_col, amount_col, date_col, date_format, first_header FROM bank_xlsstructure');
        $this->addSql('DROP TABLE bank_xlsstructure');
        $this->addSql('CREATE TABLE bank_xlsstructure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, stop_word VARCHAR(255) DEFAULT NULL, first_header VARCHAR(255) DEFAULT NULL, first_row SMALLINT NOT NULL, concept_col SMALLINT NOT NULL, amount_col SMALLINT NOT NULL, date_col SMALLINT NOT NULL, date_format VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_57B3CF5ECC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO bank_xlsstructure (id, banco_id, first_row, stop_word, concept_col, amount_col, date_col, date_format, first_header) SELECT id, banco_id, first_row, stop_word, concept_col, amount_col, date_col, date_format, first_header FROM __temp__bank_xlsstructure');
        $this->addSql('DROP TABLE __temp__bank_xlsstructure');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_57B3CF5ECC04A73E ON bank_xlsstructure (banco_id)');
        $this->addSql('DROP INDEX IDX_C8FF107ACC04A73E');
        $this->addSql('DROP INDEX IDX_C8FF107AB5DD50A6');
        $this->addSql('CREATE TEMPORARY TABLE __temp__movimiento AS SELECT id, banco_id, clon_de_id, concepto, fecha, importe, concretado FROM movimiento');
        $this->addSql('DROP TABLE movimiento');
        $this->addSql('CREATE TABLE movimiento (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, clon_de_id INTEGER DEFAULT NULL, concepto VARCHAR(255) NOT NULL, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL, concretado BOOLEAN NOT NULL, CONSTRAINT FK_C8FF107ACC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO movimiento (id, banco_id, clon_de_id, concepto, fecha, importe, concretado) SELECT id, banco_id, clon_de_id, concepto, fecha, importe, concretado FROM __temp__movimiento');
        $this->addSql('DROP TABLE __temp__movimiento');
        $this->addSql('CREATE INDEX IDX_C8FF107ACC04A73E ON movimiento (banco_id)');
        $this->addSql('CREATE INDEX IDX_C8FF107AB5DD50A6 ON movimiento (clon_de_id)');
