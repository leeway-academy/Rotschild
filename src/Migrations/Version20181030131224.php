 ...
 */
final class Version20181030131224 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bank_xlsstructure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, stop_word VARCHAR(255) DEFAULT NULL COLLATE BINARY, first_row SMALLINT NOT NULL, concept_col SMALLINT NOT NULL, amount_col SMALLINT NOT NULL, date_col SMALLINT NOT NULL, CONSTRAINT FK_57B3CF5ECC04A73E FOREIGN KEY (banco_id) REFERENCES banco (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
