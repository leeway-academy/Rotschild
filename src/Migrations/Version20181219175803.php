 ...
 */
final class Version20181219175803 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movimiento AS SELECT id, banco_id, clon_de_id, renglon_extracto_id, concepto, fecha, importe FROM movimiento');
        $this->addSql('DROP TABLE movimiento');
        $this->addSql('CREATE TABLE movimiento (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, clon_de_id INTEGER DEFAULT NULL, renglon_extracto_id INTEGER DEFAULT NULL, concepto VARCHAR(255) NOT NULL COLLATE BINARY, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL, CONSTRAINT FK_C8FF107ACC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C8FF107AB5DD50A6 FOREIGN KEY (clon_de_id) REFERENCES gasto_fijo (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C8FF107A96D3A5C1 FOREIGN KEY (renglon_extracto_id) REFERENCES renglon_extracto (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO movimiento (id, banco_id, clon_de_id, renglon_extracto_id, concepto, fecha, importe) SELECT id, banco_id, clon_de_id, renglon_extracto_id, concepto, fecha, importe FROM __temp__movimiento');
        ...
        $this->addSql('DROP INDEX UNIQ_DDE4625A58E7D5A2');
        $this->addSql('CREATE TEMPORARY TABLE __temp__applied_check AS SELECT id, number, date, source_bank, type, issuer, destination, amount FROM applied_check');
        $this->addSql('DROP TABLE applied_check');
        $this->addSql('CREATE TABLE applied_check (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, number VARCHAR(255) NOT NULL COLLATE BINARY, date DATE NOT NULL, source_bank VARCHAR(255) NOT NULL COLLATE BINARY, type VARCHAR(255) NOT NULL COLLATE BINARY, issuer VARCHAR(255) NOT NULL COLLATE BINARY, destination VARCHAR(255) NOT NULL COLLATE BINARY, amount NUMERIC(10, 2) NOT NULL)');
        $this->addSql('INSERT INTO applied_check (id, number, date, source_bank, type, issuer, destination, amount) SELECT id, number, date, source_bank, type, issuer, destination, amount FROM __temp__applied_check');
        $this->addSql('DROP TABLE __temp__applied_check');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__applied_check AS SELECT id, number, date, source_bank, type, issuer, destination, amount FROM applied_check');
        $this->addSql('DROP TABLE applied_check');
        $this->addSql('CREATE TABLE applied_check (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, number VARCHAR(255) NOT NULL, date DATE NOT NULL, source_bank VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, issuer VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, amount NUMERIC(10, 2) NOT NULL, movimiento_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO applied_check (id, number, date, source_bank, type, issuer, destination, amount) SELECT id, number, date, source_bank, type, issuer, destination, amount FROM __temp__applied_check');
        $this->addSql('DROP TABLE __temp__applied_check');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_DDE4625A58E7D5A2 ON applied_check (movimiento_id)');
        $this->addSql('DROP INDEX UNIQ_57B3CF5ECC04A73E');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movimiento AS SELECT id, banco_id, clon_de_id, renglon_extracto_id, concepto, fecha, importe FROM movimiento');
        $this->addSql('DROP TABLE movimiento');
        $this->addSql('CREATE TABLE movimiento (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, clon_de_id INTEGER DEFAULT NULL, renglon_extracto_id INTEGER DEFAULT NULL, concepto VARCHAR(255) NOT NULL, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL)');
        $this->addSql('INSERT INTO movimiento (id, banco_id, clon_de_id, renglon_extracto_id, concepto, fecha, importe) SELECT id, banco_id, clon_de_id, renglon_extracto_id, concepto, fecha, importe FROM __temp__movimiento');
        $this->addSql('DROP TABLE __temp__movimiento');
        $this->addSql('CREATE INDEX IDX_C8FF107ACC04A73E ON movimiento (banco_id)');
        $this->addSql('CREATE INDEX IDX_C8FF107AB5DD50A6 ON movimiento (clon_de_id)');
