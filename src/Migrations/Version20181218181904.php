 ...
 */
final class Version20181218181904 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movimiento (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, clon_de_id INTEGER DEFAULT NULL, concepto VARCHAR(255) NOT NULL COLLATE BINARY, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL, CONSTRAINT FK_C8FF107ACC04A73E FOREIGN KEY (banco_id) REFERENCES bank (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_C8FF107AB5DD50A6 FOREIGN KEY (clon_de_id) REFERENCES gasto_fijo (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
