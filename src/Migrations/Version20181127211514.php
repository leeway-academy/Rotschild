 ...
 */
final class Version20181127211514 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE applied_check (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, number VARCHAR(255) NOT NULL, date DATE NOT NULL, source_bank VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, issuer VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, amount NUMERIC(10, 2) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE cheque_emitido (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, numero VARCHAR(255) NOT NULL COLLATE BINARY, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL, CONSTRAINT FK_F6395884CC04A73E FOREIGN KEY (banco_id) REFERENCES banco (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE extracto_bancario (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, fecha DATE NOT NULL, archivo VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_C41BE019CC04A73E FOREIGN KEY (banco_id) REFERENCES banco (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TABLE bank_xlsstructure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, stop_word VARCHAR(255) DEFAULT NULL COLLATE BINARY, first_header VARCHAR(255) DEFAULT NULL COLLATE BINARY, first_row SMALLINT NOT NULL, concept_col SMALLINT NOT NULL, amount_col SMALLINT NOT NULL, date_col SMALLINT NOT NULL, date_format VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_57B3CF5ECC04A73E FOREIGN KEY (banco_id) REFERENCES banco (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE applied_check');
        $this->addSql('DROP INDEX UNIQ_57B3CF5ECC04A73E');
        ...
        $this->addSql('DROP TABLE bank_xlsstructure');
        $this->addSql('CREATE TABLE bank_xlsstructure (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, stop_word VARCHAR(255) DEFAULT NULL, first_header VARCHAR(255) DEFAULT NULL, first_row SMALLINT NOT NULL, concept_col SMALLINT NOT NULL, amount_col SMALLINT NOT NULL, date_col SMALLINT NOT NULL, date_format VARCHAR(255) DEFAULT NULL COLLATE BINARY)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__gasto_fijo AS SELECT id, banco_id, concepto, dia, importe, fecha_fin FROM gasto_fijo');
        $this->addSql('DROP TABLE gasto_fijo');
        $this->addSql('CREATE TABLE gasto_fijo (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, concepto VARCHAR(255) NOT NULL, dia INTEGER NOT NULL, importe NUMERIC(10, 2) NOT NULL, fecha_fin DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO gasto_fijo (id, banco_id, concepto, dia, importe, fecha_fin) SELECT id, banco_id, concepto, dia, importe, fecha_fin FROM __temp__gasto_fijo');
        $this->addSql('DROP TABLE __temp__gasto_fijo');
        $this->addSql('CREATE INDEX IDX_F9E4C2D2CC04A73E ON gasto_fijo (banco_id)');
        $this->addSql('DROP INDEX IDX_C8FF107ACC04A73E');
