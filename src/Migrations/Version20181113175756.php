 ...
 */
final class Version20181113175756 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__bank_xlsstructure AS SELECT id, banco_id, stop_word, first_row, concept_col, amount_col, date_col, date_format, first_header FROM bank_xlsstructure');
        ...
        $this->addSql('INSERT INTO bank_xlsstructure (id, banco_id, stop_word, first_row, concept_col, amount_col, date_col, date_format, first_header) SELECT id, banco_id, stop_word, first_row, concept_col, amount_col, date_col, date_format, first_header FROM __temp__bank_xlsstructure');
