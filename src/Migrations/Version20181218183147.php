 ...
 */
final class Version20181218183147 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movimiento AS SELECT id, banco_id, clon_de_id, concepto, fecha, importe FROM movimiento');
        ...
        $this->addSql('INSERT INTO movimiento (id, banco_id, clon_de_id, concepto, fecha, importe) SELECT id, banco_id, clon_de_id, concepto, fecha, importe FROM __temp__movimiento');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__movimiento AS SELECT id, banco_id, clon_de_id, concepto, fecha, importe FROM movimiento');
        $this->addSql('DROP TABLE movimiento');
        $this->addSql('CREATE TABLE movimiento (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, banco_id INTEGER NOT NULL, clon_de_id INTEGER DEFAULT NULL, concepto VARCHAR(255) NOT NULL, fecha DATE NOT NULL, importe NUMERIC(10, 2) NOT NULL)');
        $this->addSql('INSERT INTO movimiento (id, banco_id, clon_de_id, concepto, fecha, importe) SELECT id, banco_id, clon_de_id, concepto, fecha, importe FROM __temp__movimiento');
        $this->addSql('DROP TABLE __temp__movimiento');
        $this->addSql('CREATE INDEX IDX_C8FF107ACC04A73E ON movimiento (banco_id)');
        $this->addSql('CREATE INDEX IDX_C8FF107AB5DD50A6 ON movimiento (clon_de_id)');
